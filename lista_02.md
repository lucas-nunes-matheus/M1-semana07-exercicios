...
<mark>Compra 2 aprovada. Saldo restante: 0

<mark>Compra 3 aprovada com limite de crédito. Saldo restante: 200

<mark>Compra 4 negada. Saldo insuficiente e limite de crédito excedido.

<mark>Compra 5 negada. Saldo insuficiente e limite de crédito excedido.
______
...
Classe Retangulo herda FormaGeometrica:
    ...
    Método Construtor(cor, lado):
        Define o valor do atributo cor, acessando o valor do atributo "cor" da classe Pai.
        Define o valor do atributo lado com o parâmetro "lado" passado.

    Método CalcularArea(lado)
        Eleva o parâmetro "lado" ao quadrado e retorna o valor da Area.
...
Classe Circulo herda FormaGeometrica:
    ...
    Método Construtor(cor, raio):
        Define o valor do atributo cor, acessando o valor do atributo "cor" da classe Pai.
        Define o valor do atributo raio com o parâmetro "raio" passado.
    
    Método CalcularArea(raio):
        Acessa a BibliotecaMatematica, eleva o parâmetro "raio" ao quadrado, multiplica ele pela constante "pi"(da BibliotecaMatematica) e retorna o valor da Area.
...
Função ProdutoDeMatrizes(matrizA, matrizB):
    ...
    colunasMatrizA <- tamanho(matrizA[0])  # Considerando que todas as linhas têm o mesmo número de colunas
    linhasMatrizB <- tamanho(matrizB)
    colunasMatrizB <- tamanho(matrizB[0])  # Considerando que todas as linhas têm o mesmo número de colunas
    Se colunasMatrizA ≠ linhasMatrizB:
        Retornar "As matrizes não podem ser multiplicadas. O número de colunas da primeira é diferente do número de linhas da segunda"
    Senão:
